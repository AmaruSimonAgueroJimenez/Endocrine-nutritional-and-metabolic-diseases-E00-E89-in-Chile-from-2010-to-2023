...
**Title**: Comparative Network Analysis of Hospital Comorbidity Patterns in Chile (2019 vs 2023): Implications for Lifestyle Medicine

**Introduction**: Non‑communicable diseases (NCDs) account for a large share of global deaths. Many NCDs, including endocrine–nutritional–metabolic disorders, are driven by modifiable lifestyle factors—poor diet, physical inactivity, tobacco and harmful alcohol use. Chile has undergone a rapid epidemiologic transition with rising obesity, diabetes and cardiovascular disease. Understanding how these conditions cluster provides insight for holistic interventions emphasizing healthy eating, regular exercise, sleep hygiene, stress management and avoidance of risky substances.

**Objectives**: (1) Analyse the structure and evolution of hospital comorbidity networks in Chile for 2019 and 2023; (2) identify central hub diseases and disease communities; (3) detect emerging and declining comorbidity patterns; (4) quantify network metrics reflecting multimorbidity complexity; and (5) highlight targets where lifestyle interventions could prevent cascading multimorbidity.

**Materials and Methods**: De‑identified hospital discharge records from the Chilean public health system were extracted for 2019 and 2023. Secondary diagnosis fields provided ICD‑10 codes that were normalised and grouped into 48 comorbidity categories across cardiovascular, metabolic/endocrine, respiratory and other systems. Co‑occurrence networks were built from patient‑by‑comorbidity matrices, retaining edges above the 70th percentile and log‑transforming weights. Louvain community detection, centrality (degree, betweenness, eigenvector, PageRank) and k‑core analyses were performed. Bipartite projection networks sampled 5000 patients to examine patient‑level co‑occurrences. Statistical comparisons assessed changes between years. Data were publicly available and aggregated; no individual identifiers were used, respecting autonomy, beneficence, non‑maleficence and justice.

**Results**: The study included 39 comorbidities. Essential hypertension was the most prevalent condition in both years; obesity showed the greatest absolute increase (~4.1%). The proportion of patients without comorbidities fell (≈51% to 44%), indicating rising multimorbidity. Network density increased by ~1%, while global clustering decreased by ~2.2%, suggesting a more interconnected yet less tightly clustered network. The number of communities remained three. Essential hypertension had the highest centrality and gateway score, bridging metabolic, cardiovascular and renal disorders. Co‑occurrence clusters centred on hypertension–type‑2 diabetes–obesity–dyslipidaemia, with emerging links to chronic renal failure and acute renal failure. No completely new disease clusters were observed.

**Conclusions**: Chilean hospital comorbidity networks are dominated by lifestyle‑related conditions. The growing prevalence of obesity and sustained central role of hypertension highlight the need for integrated lifestyle interventions addressing diet quality, physical activity, weight management, smoking cessation and alcohol moderation. Systems‑level network analysis offers strategic targets for lifestyle medicine and public health policies to mitigate cascading multimorbidity. The use of anonymised, public datasets ensured data privacy and ethical compliance.
